...
namespace algart.Services.WebAPIRest.Controllers.API
{
    ...
    [ApiController]
    public class PlanSeparateController : Controller
    {
        private readonly IPlanSeparateApplication _Application;
        private readonly AppSettings _appSettings;

        public PlanSeparateController(IPlanSeparateApplication _Application,
        ...
        {
            Response<IEnumerable<PlanSeparateDTO>> response = new Response<IEnumerable<PlanSeparateDTO>>();
